...
def index():
    ...
    if request.method == "POST":
        ...
        return redirect("today.html", loading = False,location=location, current=current, date_time=date_time, astro=astro, daily=daily)
    else:
        data = request.args
        ...
        return render_template("today.html", loading=loading)
